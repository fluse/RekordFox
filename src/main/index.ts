...
import { startBackgroundSync, stopBackgroundSync } from './sync/syncManager'
import { handleMediaRequest, handleYoutubeStreamRequest } from './media/media'
import { ExportQueueManager } from './export/pioneer/ExportQueueManager'
import { createWindow, getMainWindow, setupActivateHandler } from './app/window'
import { createTray } from './app/tray'
import { registerIpcHandlers } from './ipc'
import { scheduleStartupAnalysis } from './analysis/backgroundAnalysis'
import { reconcileAllConnectedAccounts } from './sync/youtubeSync'
