...
// A single draggable row in the history list: cover, title/artist, duration.
export function HistoryRow({ track, onContextMenu }: HistoryRowProps): React.JSX.Element {
