export const de = {
  ...
  'sidebar.manualSourceTooltip': 'Manuell erstellte Playlist',
  ...
  'addPlaylist.platformEmpty': 'Leere Playlist',
  'addPlaylist.label': 'Playlist URL',
  'addPlaylist.labelEmpty': 'Playlist-Name',
  ...
  'addPlaylist.placeholderEmpty': 'Meine Playlist',
