export const fr = {
  ...
  'sidebar.manualSourceTooltip': 'Playlist créée manuellement',
  ...
  'addPlaylist.platformEmpty': 'Playlist vide',
  'addPlaylist.label': 'URL de la playlist',
  'addPlaylist.labelEmpty': 'Nom de la playlist',
  ...
  'addPlaylist.placeholderEmpty': 'Ma playlist',
  ...
  'preview.pitch.reset': 'Réinitialiser le pitch',
